...
export function MisHabilidadesPage() {
    ...
    function handleCaracteristicaInvalid(e) {
        e.target.setCustomValidity("Seleccioná una opción de la lista.");
    }
    ...
    function pedirConfirmacionEliminar(habilidad) {
        setHabilidadAEliminar(habilidad);
    }

    async function confirmarEliminar() {
        if (!habilidadAEliminar) return;
        const id = habilidadAEliminar.id;
    ...
    return (
        <main className="container">
                    ...
                    <form className="form-layout" onSubmit={handleSubmit}>
                        <div className="field">
                            ...
                            <select
                                ...
                                onInvalid={handleCaracteristicaInvalid}
                                required
                            >
                                    ...
                                    <tr key={h.id}>
                                        ...
                                        <td>
                                            <button
                                                ...
                                                onClick={() => pedirConfirmacionEliminar(h)}
                                            >
                                                ✕
                                            </button>
                                        </td>
            ...
            <ConfirmDialog
                open={habilidadAEliminar !== null}
                title="Eliminar habilidad"
                message={
                    habilidadAEliminar
                        ? `¿Estás seguro de que querés eliminar "${habilidadAEliminar.rutaCompleta}"?`
                        : ""
                }
                ...
                onCancel={() => setHabilidadAEliminar(null)}
            />
        </main>
    );
}